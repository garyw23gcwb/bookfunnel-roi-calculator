...
| File | What it is |
| --- | --- |
| `docs/index.html` | Deployable page. Fonts load from Google Fonts, logos inlined. 82 KB. |
...
placeholders are replaced with base64 of the font and logo files; `docs/index.html`
...
2. Settings, Pages, deploy from `main` branch, `/docs` folder. GitHub Pages only
   accepts `/` or `/docs` as a source, which is why the built page lives in `docs/`.
   The page lands at `https://garyw23gcwb.github.io/bookfunnel-roi-calculator/`.
